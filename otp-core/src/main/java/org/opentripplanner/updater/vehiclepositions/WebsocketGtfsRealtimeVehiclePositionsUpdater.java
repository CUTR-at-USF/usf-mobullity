 ...
 *
 */
public class WebsocketGtfsRealtimeVehiclePositionsUpdater implements GraphUpdater {
    /**
    ...
    private static Logger LOG = LoggerFactory.getLogger(WebsocketGtfsRealtimeVehiclePositionsUpdater.class);
    ...
    private class Listener extends DefaultWebSocketListener {
        ...
        public void onMessage(byte[] message) {
            ...
            // this is where updates should be done!
