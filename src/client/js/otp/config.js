  ...
  //               }
    ...
    infoWidgets: [
    	...
    	content: '<p><img src="images/locationSpot.svg" height="15" width="15"> : Current Location<br>\
    		...
    		<p> We would like to acknowledge the support and funding assistance provided by the USF Student Green Energy Fund, Center for Urban Transportation Research, and Florida Department of Transportation.' 
        },
        {	
	title: 'Contact',
