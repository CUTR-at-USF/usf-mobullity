...
L.layersIcon = L.DivIcon.extend({
    options: {
        ...
        color: 'blue', /* defined in style.css layersIcon-{color} */
	iconContent: '',
    },
...
//        }
  ...
  //               }
    ...
    layersWidget: [
        ...
        { name: 'smart_kiosks', target: '#smart_kiosks', icon: new L.layersIcon({icon: 'mdi mdi-monitor', color: 'blue'}), type: 'poi', search: 'tourism:terminal', popupTemplate: 'kiosk-template', color: '#10abe9' },
